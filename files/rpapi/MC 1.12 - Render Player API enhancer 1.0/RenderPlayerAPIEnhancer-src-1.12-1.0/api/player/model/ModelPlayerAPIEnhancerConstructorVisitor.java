...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bpv")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bpv") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
