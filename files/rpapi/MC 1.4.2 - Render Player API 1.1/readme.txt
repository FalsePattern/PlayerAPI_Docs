...
Version 1.1 for Minecraft 1.4.2
...
Render Player API is an API which gives client mods access to the client classes "RenderPlayer" aka "baq" minimizing conflicts between mods.
