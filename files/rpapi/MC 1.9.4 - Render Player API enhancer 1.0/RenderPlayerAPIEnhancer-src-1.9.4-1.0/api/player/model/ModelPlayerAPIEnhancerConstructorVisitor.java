...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("biv")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("biv") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
