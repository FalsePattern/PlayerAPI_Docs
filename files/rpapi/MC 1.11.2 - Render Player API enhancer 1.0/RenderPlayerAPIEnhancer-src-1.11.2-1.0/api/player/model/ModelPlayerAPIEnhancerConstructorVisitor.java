...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bln")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bln") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
