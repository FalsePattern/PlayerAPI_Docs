...
public final class ModelPlayerAPI
{
	...
	private static void register(Class<?> baseClass, String id, ModelPlayerBaseSorting baseSorting)
	{
		if(!isCreated)
		{
			...
			catch(NoSuchMethodException exception)
			{
				...
				{
					"========================================",
					"The API \"Model Player\" version 1.1 of the mod \"Render Player API core 1.1\" can not be created!",
					"----------------------------------------",
		...
		addMethod(id, baseClass, beforeLocalConstructingHookTypes, "beforeLocalConstructing", float.class, boolean.class);
		addMethod(id, baseClass, afterLocalConstructingHookTypes, "afterLocalConstructing", float.class, boolean.class);
	...
	public static ModelPlayerAPI create(IModelPlayerAPI modelPlayer, float paramFloat, boolean paramBoolean, String type)
	{
		if(allBaseConstructors.size() > 0 && !initialized)
			initialize();
		return new ModelPlayerAPI(modelPlayer, paramFloat, paramBoolean, type);
	}
	...
	public static void beforeLocalConstructing(IModelPlayerAPI modelPlayer, float paramFloat, boolean paramBoolean)
	{
		...
		if(modelPlayerAPI != null)
			modelPlayerAPI.beforeLocalConstructing(paramFloat, paramBoolean);
	}

	public static void afterLocalConstructing(IModelPlayerAPI modelPlayer, float paramFloat, boolean paramBoolean)
	{
		ModelPlayerAPI modelPlayerAPI = modelPlayer.getModelPlayerAPI();
		if(modelPlayerAPI != null)
			modelPlayerAPI.afterLocalConstructing(paramFloat, paramBoolean);
	}
	...
	private ModelPlayerAPI(IModelPlayerAPI modelPlayer, float paramFloat, boolean paramBoolean, String type)
	{
	...
	private void beforeLocalConstructing(float paramFloat, boolean paramBoolean)
	{
		if(beforeLocalConstructingHooks != null)
			for(int i = beforeLocalConstructingHooks.length - 1; i >= 0 ; i--)
				beforeLocalConstructingHooks[i].beforeLocalConstructing(paramFloat, paramBoolean);
		beforeLocalConstructingHooks = null;
	}

	private void afterLocalConstructing(float paramFloat, boolean paramBoolean)
	{
		if(afterLocalConstructingHooks != null)
			for(int i = 0; i < afterLocalConstructingHooks.length; i++)
				afterLocalConstructingHooks[i].afterLocalConstructing(paramFloat, paramBoolean);
