...
public final class ModelPlayerConstructorVisitor extends MethodVisitor
{
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf)
	{
		...
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bix" : "net/minecraft/client/model/ModelBiped"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "bjf" : "net/minecraft/client/model/ModelPlayer", "modelPlayerAPI", "Lapi/player/model/ModelPlayerAPI;");
