...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bjp")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bjp") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
