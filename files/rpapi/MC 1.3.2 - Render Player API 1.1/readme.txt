...
Version 1.1 for Minecraft 1.3.2
...
Render Player API is an API which gives client mods access to the client classes "RenderPlayer" aka "awr" minimizing conflicts between mods.
