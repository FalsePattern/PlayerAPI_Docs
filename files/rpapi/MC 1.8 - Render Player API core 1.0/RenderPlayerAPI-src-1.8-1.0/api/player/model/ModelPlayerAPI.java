...
public final class ModelPlayerAPI
{
	...
	public static ModelPlayerAPI create(IModelPlayerAPI modelPlayer)
	{
	...
	public static net.minecraft.client.model.ModelPlayer[] getAllInstances()
	{
		return allInstances.toArray(new net.minecraft.client.model.ModelPlayer[allInstances.size()]);
	}
	...
	private ModelPlayerAPI(IModelPlayerAPI modelPlayer)
	{
