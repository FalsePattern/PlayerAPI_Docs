...
In case you want to debug into the Render Player API source code add the file "%source.file%" to the source lookup path of the run/debug configurations of your Minecraft Forge development installation.