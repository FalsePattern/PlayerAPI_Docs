...
Version 1.2 for Minecraft 1.2.5
...
Render Player API is an API which gives client mods access to the client classes "RenderPlayer" aka "wa" minimizing conflicts between mods.
