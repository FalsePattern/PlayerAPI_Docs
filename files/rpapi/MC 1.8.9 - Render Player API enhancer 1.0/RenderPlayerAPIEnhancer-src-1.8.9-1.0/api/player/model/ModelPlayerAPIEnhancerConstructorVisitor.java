...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bbj")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bbj") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
