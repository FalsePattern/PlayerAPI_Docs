...
public final class ModelPlayerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bqh" : "net/minecraft/client/model/ModelPlayer"))
		{
			desc = desc.substring(0, desc.indexOf(")")) + "Ljava/lang/String;)V";
			mv.visitVarInsn(Opcodes.ALOAD, parameterOffset);
		}
		super.visitMethodInsn(opcode, owner, name, desc, itf);
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bpv" : "net/minecraft/client/model/ModelBiped"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "bqh" : "net/minecraft/client/model/ModelPlayer", "modelPlayerAPI", "Lapi/player/model/ModelPlayerAPI;");
