...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bix")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bix") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
