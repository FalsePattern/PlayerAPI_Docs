...
public class ModelPlayerAPIEnhancerConstructorVisitor extends MethodVisitor
{
	...
	{
		if(name.equals("<init>") && ((isObfuscated && owner.equals("bll")) || owner.equals("net/minecraft/client/model/ModelBiped")))
			owner = owner.equals("bll") ? "api/player/model/ModelPlayerArmor" : "api/player/model/ModelPlayerArmor";
