...
public final class RenderPlayerConstructorVisitor extends MethodVisitor
{
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc)
	{
		...
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bnz" : "net/minecraft/client/renderer/entity/RendererLivingEntity"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "boh" : "net/minecraft/client/renderer/entity/RenderPlayer", "renderPlayerAPI", "Lapi/player/render/RenderPlayerAPI;");
