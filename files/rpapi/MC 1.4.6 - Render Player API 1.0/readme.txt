...
Version 1.0 for Minecraft 1.4.6
...
Render Player API is an API which gives client mods access to the client classes "RenderPlayer" aka "bco" minimizing conflicts between mods.
