...
based on Render Player API vanilla 1.0 for Minecraft 1.6.1
...
Render Player API is a Minecraft Forge core mod which gives client mods access to the client classes "RenderPlayer" aka "bgy" minimizing conflicts between mods.
