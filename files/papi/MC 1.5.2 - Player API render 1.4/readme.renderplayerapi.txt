...
Version 1.3 for Minecraft 1.5.2
...
Render Player API is an API which gives client mods access to the client classes "RenderPlayer" aka "bht" minimizing conflicts between mods.
