...
public final class ClientPlayerConstructorVisitor extends MethodVisitor
{
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc)
	{
		...
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bkz" : "net/minecraft/client/entity/AbstractClientPlayer"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "blc" : "net/minecraft/client/entity/EntityPlayerSP", "clientPlayerAPI", "Lapi/player/client/ClientPlayerAPI;");
