...
* client mods access to the client classes "EntityPlayerSP" aka "bfd" and "EntityPlayerMP" aka "jc"
* server mods access to the server class and "EntityPlayerMP" aka "jc"
