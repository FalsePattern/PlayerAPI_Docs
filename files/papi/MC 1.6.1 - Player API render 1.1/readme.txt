...
Copy all class files inside this ZIP file to their corresponding locations inside the JAR file of the Minecraft 1.6.1 version you want to install Player API render to.
