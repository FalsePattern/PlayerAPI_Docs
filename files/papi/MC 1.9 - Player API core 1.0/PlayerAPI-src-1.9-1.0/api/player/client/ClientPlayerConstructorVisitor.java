...
public final class ClientPlayerConstructorVisitor extends MethodVisitor
{
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf)
	{
		...
		if(name.equals("<init>") && owner.equals(isObfuscated ? "bmq" : "net/minecraft/client/entity/AbstractClientPlayer"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "bmt" : "net/minecraft/client/entity/EntityPlayerSP", "clientPlayerAPI", "Lapi/player/client/ClientPlayerAPI;");
