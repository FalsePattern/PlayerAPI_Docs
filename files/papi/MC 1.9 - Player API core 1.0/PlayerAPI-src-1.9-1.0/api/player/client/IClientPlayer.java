...
public interface IClientPlayer
{
	...
	net.minecraft.entity.player.EntityPlayer.EnumStatus realTrySleep(net.minecraft.util.math.BlockPos paramBlockPos);

	net.minecraft.entity.player.EntityPlayer.EnumStatus superTrySleep(net.minecraft.util.math.BlockPos paramBlockPos);

	net.minecraft.entity.player.EntityPlayer.EnumStatus localTrySleep(net.minecraft.util.math.BlockPos paramBlockPos);
