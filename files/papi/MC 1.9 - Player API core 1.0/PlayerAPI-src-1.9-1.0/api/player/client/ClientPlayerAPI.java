...
public final class ClientPlayerAPI
{
	...
	public static net.minecraft.entity.player.EntityPlayer.EnumStatus trySleep(IClientPlayerAPI target, net.minecraft.util.math.BlockPos paramBlockPos)
	{
	...
	private net.minecraft.entity.player.EntityPlayer.EnumStatus trySleep(net.minecraft.util.math.BlockPos paramBlockPos)
	{
