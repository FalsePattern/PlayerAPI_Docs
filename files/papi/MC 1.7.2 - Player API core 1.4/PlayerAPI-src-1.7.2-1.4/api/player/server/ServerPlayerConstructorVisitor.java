...
public final class ServerPlayerConstructorVisitor extends MethodVisitor
{
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc)
	{
		...
		if(name.equals("<init>") && owner.equals(isObfuscated ? "xl" : "net/minecraft/entity/player/EntityPlayer"))
		{
			...
			mv.visitFieldInsn(Opcodes.PUTFIELD, isObfuscated ? "mm" : "net/minecraft/entity/player/EntityPlayerMP", "serverPlayerAPI", "Lapi/player/server/ServerPlayerAPI;");
