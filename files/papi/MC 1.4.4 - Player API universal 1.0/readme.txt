...
Version 1.0 for Minecraft 1.4.4
...
* client mods access to the client classes "EntityPlayerSP" aka "aym" and "EntityPlayerMP" aka "ih"
* server mods access to the server class and "EntityPlayerMP" aka "ih"
